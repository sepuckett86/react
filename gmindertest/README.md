...
The purpose of this app is to learn how to connect with a php backend! <br>

sepuckett86 in collaboration with codegold79.<br>

To load:<br>

Clone repository. Navigate to `gmindertest` directory.
