    ...
    return (
      <div>
        ...
        <div className="progress active">
          <div className="progress-bar progress-bar-striped bg-danger" style={this.votesAngularInPercentStyle()}></div>
        </div>
        <span className="label label-info">React: {this.votesReactInPercent().toFixed(2) + '%'}</span>
        <div className="progress active">
          <div className="progress-bar progress-bar-striped bg-info" style={this.votesReactInPercentStyle()}></div>
        </div>
        <span className="label label-success">Vue.js: {this.votesVuejsInPercent().toFixed(2) + '%'}</span>
        <div className="progress active">
          <div className="progress-bar progress-bar-striped bg-success" style={this.votesVuejsInPercentStyle()}></div>
        </div>
      </div>
    )
  }
