...
Disregard following info for now:

Things to do so it will work for you
<br>
Make sure you have Node downloaded.
<br>
Clone directory
<br>
Go to 'gminder/src/Utils/KeysTemplate.js'
<br>
Change file name to Keys.js
<br>
Put in clientID and orgURL as supplied by Susan. Save it.
<br>
`npm install`
<br>
`npm start`

## Generic Content Below
