      ...
      <div className="container">
        ...
        <div className="container">
          <div className="box-clear" >
              ...
              <ul>
                <li>Record positive life experiences to read at a later date.
                </li>
                ...
                <li>Export all of your saved thoughts, including as a PDF that can be printed as a book.
                </li>
              </ul>
        ...
        <br />
          <p>
            <a href="/" className='button-standard'>
              <i className="fas fa-arrow-circle-right"></i>Get Started</a>
          </p>
          <br />
            <br /></main>
